...
VAD_ENABLED = True
VAD_ENERGY_THRESHOLD = 150  # Further lowered for maximum sensitivity
VAD_SILENCE_DURATION_MS = 500
VAD_MIN_SPEECH_DURATION_MS = 200
VAD_HIGH_PASS_CUTOFF = 100.0  # Lowered from 200.0 to preserve more frequencies
VAD_MIN_CONSECUTIVE_FRAMES = 1  # Lowered from 3 for more responsive detection
VAD_SPECTRAL_FLATNESS_THRESHOLD = 0.9  # Increased from 0.8 to be less restrictive
VAD_BARGE_IN_CONSECUTIVE_FRAMES = 1  # Lowered from 2 for faster barge-in detection
VAD_BARGE_IN_ENABLED = True
VAD_DEBUG_LOGGING = True  # Enabled for debugging
