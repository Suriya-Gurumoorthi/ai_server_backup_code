...
# PRIMARY AUDIO PATH: Ultravox now sends audio directly via WebSocket (no TTS conversion needed)
...
VAD_SILENCE_DURATION_MS = 750  # Silence duration to end speech (milliseconds) - Reduced for faster response
VAD_MIN_SPEECH_DURATION_MS = 250 # Minimum speech duration to process (milliseconds) - Reduced for faster initial response
...
VAD_MIN_CONSECUTIVE_FRAMES = 3  # Minimum consecutive frames required for speech detection (debounce) - Reduced for faster response
